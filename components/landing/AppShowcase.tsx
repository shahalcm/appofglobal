  ...
  const screens: ScreenTab[] = [
    {
      ...
      mockupContent: (
        <div className="h-full w-full bg-brand-dark text-white p-4 pt-8 flex flex-col justify-between overflow-hidden">
          {/* Top Bar */}
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            ...
            <span className="text-[10px] bg-primary/40 text-secondary px-2 py-0.5 rounded border border-secondary/30">
              Live App
            </span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 my-2">
            <div className="bg-white/5 rounded-xl p-2 text-center border border-white/5 hover:border-secondary/40 transition-colors">
          ...
          <div className="bg-linear-to-br from-primary/25 to-white/5 rounded-2xl p-3 border border-primary/30 my-2">
            <div className="flex items-center justify-between text-[10px] mb-1">
              <span className="text-secondary font-bold">PROMOTED TRADE OFFER</span>
      ...
      mockupContent: (
        <div className="h-full w-full bg-brand-dark text-white p-4 pt-8 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative h-44 w-full rounded-2xl overflow-hidden my-3 border border-white/10">
            ...
            <div className="absolute bottom-2 left-2 bg-dark-blue/90 backdrop-blur-md px-2.5 py-1 rounded-lg text-[10px] font-semibold text-white">
              Export Grade A
            </div>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-white/10 flex gap-2">
            <button className="flex-1 bg-primary hover:bg-primary-hover text-white py-2 rounded-xl text-xs font-bold transition-colors">
              Chat With Supplier
            </button>
        ...
        <div className="h-full w-full bg-brand-dark text-white p-4 pt-8 flex flex-col justify-between overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2 my-3">
            <div className="bg-white/5 rounded-xl p-2.5 border border-white/10">
              ...
              <div className="text-base font-extrabold text-secondary">48 Listings</div>
            </div>
            <div className="bg-white/5 rounded-xl p-2.5 border border-white/10">
          ...
          <button className="w-full bg-linear-to-r from-primary to-secondary text-white py-2.5 rounded-xl text-xs font-bold shadow-md">
    ...
    },
    {
      ...
      mockupContent: (
        <div className="h-full w-full bg-brand-dark text-white p-4 pt-8 flex flex-col justify-between overflow-hidden">
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-[10px] font-bold">
                ES
              </div>
              <div>
          ...
          <div className="my-auto space-y-2.5 text-[11px]">
            ...
            <div className="bg-primary text-white rounded-2xl rounded-tr-sm p-2.5 max-w-[80%] ml-auto text-right">
          ...
          <div className="pt-2 border-t border-white/10 flex items-center gap-2">
            ...
            <button className="w-8 h-8 rounded-xl bg-primary flex items-center justify-center text-white">
      ...
      <Container>
            ...
            <button
              ...
              className={`px-4 sm:px-6 py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 cursor-pointer ${
                activeTab === screen.id
                  ...
                  : "bg-slate-100 text-dark-blue/80 hover:bg-slate-200"
              }`}
            >
              {screen.name}
            </button>
        ...
        <div className="bg-slate-50 rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-200/90 shadow-lg grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="inline-block px-3 py-1 rounded-full text-xs font-bold text-primary bg-accent border border-primary/15 mb-4">
              {currentScreen.badge}
            </div>

            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-dark-blue mb-4">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-70 sm:w-77.5 h-145 bg-dark-blue rounded-[48px] p-3 shadow-2xl border-4 border-[#1c2c5c] ring-1 ring-slate-200">
              {/* Dynamic Island */}
