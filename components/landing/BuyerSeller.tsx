      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/90 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-[#0B4DFF] to-[#1DA1FF]" />

            <div>
              {/* Badge & Role */}
              <div className="flex items-center justify-between mb-6">
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[#0B4DFF] bg-[#EAF4FF] border border-[#0B4DFF]/15">
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#0A1A44] mb-4">
              ...
              <div className="space-y-3.5 mb-10">
                {BUYER_FEATURES.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#EAF4FF] text-[#0B4DFF] flex items-center justify-center shrink-0 mt-0.5">
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-[#0A1A44] rounded-3xl p-8 sm:p-10 border border-slate-700/60 shadow-2xl text-white flex flex-col justify-between relative overflow-hidden group">
            {/* Ambient accent top bar */}
            <div className="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-[#1DA1FF] to-[#00D2FF]" />
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#1DA1FF]/10 blur-3xl pointer-events-none -z-0" />

            <div className="relative z-10">
              {/* Badge & Role */}
              <div className="flex items-center justify-between mb-6">
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[#1DA1FF] bg-[#1DA1FF]/15 border border-[#1DA1FF]/25">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-3.5 mb-10">
                {SELLER_FEATURES.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#1DA1FF]/20 text-[#1DA1FF] flex items-center justify-center shrink-0 mt-0.5">
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
